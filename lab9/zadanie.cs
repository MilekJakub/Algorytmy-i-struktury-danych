namespace zadanie
{
    ...
    public class HashMap<Key, Value> : IEnumerable<Pair<Key, Value>>
    {
        ...
        public bool PutIfAbsent(Key key, Value value)
        {
            ...
            _values[hash] = new List<Pair<Key, Value>>();

            _values[hash].Add(new Pair<Key, Value>() { Key = key, Value = value });
        ...
        public bool Replace(Key key, Value value)
        {
            ...
            var newValue = new List<Pair<Key, Value>>();
            newValue.Add(new Pair<Key, Value>() { Key = key, Value = value });

            _values[hash] = newValue;
